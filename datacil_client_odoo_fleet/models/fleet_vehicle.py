...
class FleetVehicle(models.Model):
    ...
    def _datacil_vehicle_values(self, data, plate_label):
        ...
        # Keep the model year only when it is one of the selectable years.
        if values['model_year'] not in dict(self._fields['model_year']._description_selection(self.env)):
